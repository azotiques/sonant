    ...
    <div className="flex flex-col gap-y-3">
      ...
      <div className="flex flex-col">
        <form action={formAction}>
          <div
            className={cn(
              "flex flex-row items-center justify-between gap-x-2 px-4 py-3 w-180 border-zinc-800 shadow-zinc-950/40 shadow-xl border-1 rounded-4xl text-white break-normal",
              message &&
                "flex flex-row items-center justify-between gap-x-2 px-4 py-3 w-180 border-red-400 shadow-zinc-950/40 shadow-xl border-1 rounded-4xl text-white break-normal"
            )}
          >
            <input
